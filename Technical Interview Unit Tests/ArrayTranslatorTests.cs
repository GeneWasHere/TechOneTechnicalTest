...
{
    [TestClass]
    public sealed class ArrayTranslatorTests
    {
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(9);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(12);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(17);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(10);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(20);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(80);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(33);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(100);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(123);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(105);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(110);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1005);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1001);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1234);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(10000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(100000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1000000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1000001);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(10000000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(100000000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(100000001);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(9876543210);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1000000001);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(10000000000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(100000000000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1000000000000);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1000000000001);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(1234567890123);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(0000123);
            Assert.AreEqual("One Hundred and Twenty-Three", result);
        }
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(0);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(int.MaxValue);
        ...
        //{
        //    string result = translator.ArrayTranslatorAlgorithm(long.MinValue);
        //    Assert.AreEqual("Error: Number is at the lowest possible number of long, an unrealistic input", result);
        //}
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(long.MinValue);
            Assert.AreEqual("Negative Nine Quintillion Two Hundred Twenty-Three Quadrillion Three Hundred Seventy-Two Trillion Thirty-Six Billion Eight Hundred Fifty-Four Million Seven Hundred Seventy-Five Thousand Eight Hundred Seven", result);
        }

        [TestMethod]
        public void TestEdge_MaxLong()
        {
            string result = translator.ArrayTranslatorAlgorithm(long.MaxValue);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(-123456789012345);
        ...
        {
            string result = translator.ArrayTranslatorAlgorithm(0L);
            Assert.AreEqual("Zero", result);
        }
    }
}